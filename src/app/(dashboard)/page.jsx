                    ...
                    <tbody>
                      {preRegistrations.map(preReg => (
                        <tr key={preReg.id}>
                          ...
                          <td>
                            <button className="delete tableBtn" onClick={() => handlePreRegDelete(preReg.id)}>Delete</button>
                            <button className="validate tableBtn" onClick={() => handleValidate(preReg.id)}>Validate</button>
                          </td>
                        </tr>
                      ))}
                    </tbody>
                      ...
                      <tbody>
                        {absenceList.map(absence => (
                          <tr key={absence.id}>
                            ...
                            <td>
                              <button className="delete tableBtn" onClick={() => handleAbsenceDelete(absence.id)}>Delete</button>
                            </td>
                          </tr>
                        ))}
                      </tbody>
